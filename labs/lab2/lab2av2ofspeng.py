...
((100, 234, 150), (104, 255, 170)),  # DARK green
((107, 81, 80),   (85, 255, 255)),   # green
((90, 80, 80),    (120, 255, 255))   # blue
]
...
def update_contour():
    ...
    if image is None:
        ...
        for testingColour in COLORS:
            countours = rc_utils.find_contours(image, testingColour[0], testingColour[1])
...
def start():
    ...
    rc.set_update_slow_time(0.0000000000000000000000000000000001)
...
def update():
    ...
    if contour_center is not None:
        ...
        angle = contour_center[1] - camera_width
