...
#here we suppose that we only have those three colours. 
COLORS = [
((0, 100, 100), (179, 255, 255))#redd
((107, 81, 80),   (85, 255, 255))#greenn
((90, 80, 80),    (120, 255, 255))#bluee
]
...
def line_following():#this is to drive the car with porpotional controll
    ...
    if contour_center is not None:
        ...
        #if contour_center is not None:
        angle = (contour_center[1] - 320) / 320
...
def update_state():
    return 0#tha vazoume pragna gia armark
...
def update_contour():
    ...
    if image is None:
        ...
        image = rc_utils.crop(image, [320,180],[475,410] )#320 ,640
...
def update():
    ...
    state = update_state()
    #this will be the main that will call everything
