...
areaof30 = 192 #idk why this number is like this but it look interesting
...
def update():
    ...
    if contour is not None:
        ...
        #serch for da f ing velocity
        speed = areaof30 - contour_area
        speed /= areaof30
        
        #the f ing limit of the angle thingy
        if abs(angle) < 0.1:
            angle = 0
